...
{
    _tfID.placeholder = [NSString stringWithFormat:@"%d", _model.ID];
    _tfName.text =_model.NAME;
    _tfPhone.text = _model.PHONE;
    _iconImage.image = [UIImage imageWithData:_model.ICON ];
}
